...
\HRule \\[0.4cm]
{ \huge \bfseries Digital signal processing:

On-edge CNN}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\emph{Begeleiders:} \\
Lode \textsc{Vuegen} \\% Supervisor's Name
Suraj \textsc{Khan} % second supervisor's Name
